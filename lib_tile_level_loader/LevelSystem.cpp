...
void LevelSystem::loadLevelFile(const std::string& path, float tileSize) {
	...
	for (int i = 0; i < buffer.size(); ++i) {
		...
		case 'n':
			...
			break;
		case 'x':
			temp_tiles.push_back(INTERSECTION);
			break;
		case '\n':			// end of line
...
size_t LevelSystem::getTileSize() { return _tileSize; }
size_t LevelSystem::getWindowWidth() { return (_width * (size_t)_tileSize); }
size_t LevelSystem::getWindowHeight() { return (_height * (size_t)_tileSize); }
